...
class SettingsTab extends StatelessWidget {
  ...
  Widget _buildListItem({
    ...
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        border: isLast ? null : Border(bottom: BorderSide(color: const Color(0xFFF8FAFC))),
      ),
      child: Row(
        children: [
          Container(
          ...
          if (hasSwitch)
            ...
            Icon(PhosphorIcons.caretRight(PhosphorIconsStyle.bold), size: 16, color: const Color(0xFFCBD5E1))
        ],
      ),
    );
  }
